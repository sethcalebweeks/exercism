...
var $author$project$ValentinesDay$BoardGame = {$: 'BoardGame'};
var $author$project$ValentinesDay$Chill = {$: 'Chill'};
var $author$project$ValentinesDay$Crime = {$: 'Crime'};
var $author$project$ValentinesDay$Horror = {$: 'Horror'};
var $author$project$ValentinesDay$Korean = {$: 'Korean'};
var $author$project$ValentinesDay$Maybe = {$: 'Maybe'};
var $author$project$ValentinesDay$Movie = function (a) {
	return {$: 'Movie', a: a};
};
var $author$project$ValentinesDay$No = {$: 'No'};
var $author$project$ValentinesDay$Restaurant = function (a) {
	return {$: 'Restaurant', a: a};
};
var $author$project$ValentinesDay$Romance = {$: 'Romance'};
var $author$project$ValentinesDay$Thriller = {$: 'Thriller'};
var $author$project$ValentinesDay$Turkish = {$: 'Turkish'};
var $author$project$ValentinesDay$Yes = {$: 'Yes'};
...
var $author$project$ValentinesDay$rateActivity = function (activity) {
	switch (activity.$) {
		case 'BoardGame':
			return $author$project$ValentinesDay$No;
		case 'Chill':
			return $author$project$ValentinesDay$No;
		case 'Movie':
			if (activity.a.$ === 'Romance') {
				var _v1 = activity.a;
				return $author$project$ValentinesDay$Yes;
			} else {
				return $author$project$ValentinesDay$No;
			}
		default:
			if (activity.a.$ === 'Korean') {
				var _v2 = activity.a;
				return $author$project$ValentinesDay$Yes;
			} else {
				var _v3 = activity.a;
				return $author$project$ValentinesDay$Maybe;
			}
	}
};
				...
				[
					...
					function (_v0) {
						return A2(
							...
							$author$project$ValentinesDay$No,
							$author$project$ValentinesDay$rateActivity($author$project$ValentinesDay$BoardGame));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'chill rated no',
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$ValentinesDay$No,
							$author$project$ValentinesDay$rateActivity($author$project$ValentinesDay$Chill));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'crime movie rated no',
					function (_v2) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$ValentinesDay$No,
							$author$project$ValentinesDay$rateActivity(
								$author$project$ValentinesDay$Movie($author$project$ValentinesDay$Crime)));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'horror movie rated no',
					function (_v3) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$ValentinesDay$No,
							$author$project$ValentinesDay$rateActivity(
								$author$project$ValentinesDay$Movie($author$project$ValentinesDay$Horror)));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'romance movie rated yes',
					function (_v4) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$ValentinesDay$Yes,
							$author$project$ValentinesDay$rateActivity(
								$author$project$ValentinesDay$Movie($author$project$ValentinesDay$Romance)));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'thriller movie rated no',
					function (_v5) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$ValentinesDay$No,
							$author$project$ValentinesDay$rateActivity(
								$author$project$ValentinesDay$Movie($author$project$ValentinesDay$Thriller)));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'korean restaurant rated no',
					function (_v6) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$ValentinesDay$Yes,
							$author$project$ValentinesDay$rateActivity(
								$author$project$ValentinesDay$Restaurant($author$project$ValentinesDay$Korean)));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'turkish restaurant rated maybe',
					function (_v7) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$ValentinesDay$Maybe,
							$author$project$ValentinesDay$rateActivity(
								$author$project$ValentinesDay$Restaurant($author$project$ValentinesDay$Turkish)));
					})
				]))
		]));
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['/home/caleb/exercism/elm/valentines-day/tests/Tests.elm']),
		processes: 4,
...
var pipeFilename = "/tmp/elm_test-9106.sock";
var net = require('net'),
