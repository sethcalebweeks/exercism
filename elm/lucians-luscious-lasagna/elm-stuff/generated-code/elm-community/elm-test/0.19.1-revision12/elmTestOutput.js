...
var $author$project$LuciansLusciousLasagna$elapsedTimeInMinutes = F2(
	function (layers, timeInOven) {
		return timeInOven + $author$project$LuciansLusciousLasagna$preparationTimeInMinutes(layers);
	});
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['/home/caleb/exercism/elm/lucians-luscious-lasagna/tests/Tests.elm']),
		processes: 4,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: 100,
		seed: 406780574908683
	},
	_List_fromArray(
		[
			_Utils_Tuple2(
...
var pipeFilename = "/tmp/elm_test-4850.sock";
var net = require('net'),
