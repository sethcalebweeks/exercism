...
var $author$project$MariosMarvellousLasagna$remainingTimeInMinutes = F2(
	function (layers, minutesSinceStarting) {
		var preparationTimeInMinutes = function (numLayers) {
			return numLayers * 2;
		};
		var expectedMinutesInOven = 40;
		return (expectedMinutesInOven + preparationTimeInMinutes(layers)) - minutesSinceStarting;
	});
		...
		[
			...
			_List_fromArray(
				[
					...
					'For a 3-layers lasagna started 10 minutes ago, there are 36 minutes remaining',
					function (_v0) {
						return A2(
							$elm_explorations$test$Expect$equal,
							((3 * 2) + 40) - 10,
							A2($author$project$MariosMarvellousLasagna$remainingTimeInMinutes, 3, 10));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'For a 6-layers lasagna started 30 minutes ago, there are 22 minutes remaining',
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$equal,
							((6 * 2) + 40) - 30,
							A2($author$project$MariosMarvellousLasagna$remainingTimeInMinutes, 6, 30));
					})
				]))
		]));
...
var pipeFilename = "/tmp/elm_test-8117.sock";
var net = require('net'),
